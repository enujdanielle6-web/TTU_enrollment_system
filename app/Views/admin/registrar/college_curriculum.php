        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
              <h1 class="h4 fw-bold text-dark mb-0">College Curricula Management</h1>
              ...
              <span class="badge bg-light text-secondary border rounded-pill px-2.5 py-0.5 small fw-semibold">
                <i class="bi bi-layers text-primary me-1"></i><?= count($curricula ?? []) ?> Plans
              </span>
            </div>
            <p class="text-muted small mb-0">Manage academic semester plans, subject sequencing, and degree curricula.</p>
          </div>
        </div>
