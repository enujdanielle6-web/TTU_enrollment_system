        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
              <a href="shs_curriculum.php" class="btn btn-sm btn-light border rounded-pill px-2.5 py-0.5 extra-small text-muted me-1">
              ...
              <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 rounded-pill px-2.5 py-0.5 small fw-semibold">
                <?= htmlspecialchars($curriculum['strand_code']) ?>
              </span>
            ...
            <p class="text-muted small mb-0"><?= htmlspecialchars($curriculum['strand_name'] ?? '') ?> • Effective AY: <?= htmlspecialchars($curriculum['effective_academic_year'] ?? 'N/A') ?> • Manage semester tracks and subject prerequisites.</p>
          </div>
        </div>
        <div class="d-flex flex-wrap align-items-center gap-2">
          <?php if ($curriculum['status'] === 'draft'): ?>
            <button class="btn btn-primary rounded-pill px-3 py-2 fw-medium shadow-sm d-inline-flex align-items-center gap-1.5" data-bs-toggle="modal" data-bs-target="#addSubjectModal" onclick="openAddSubjectModalGlobal()">
