        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            <div class="d-flex align-items-center gap-2 mb-1 flex-wrap">
              <h1 class="h4 fw-bold text-dark mb-0">College Enrollment Queue</h1>
              ...
              <span class="badge bg-light text-secondary border rounded-pill px-2.5 py-0.5 small fw-semibold">
                <i class="bi bi-layers text-primary me-1"></i><?= count($applications ?? []) ?> Ready for Matriculation
              </span>
            </div>
    ...
    <div class="dossier-card mb-4 fade-in-up" style="animation-delay: 0.1s;">
      <div class="dossier-card-header py-2.5 px-3 bg-light border-bottom d-flex justify-content-between align-items-center">
        ...
        <?php if (($search ?? '') !== '' || ($sortOrder ?? 'newest') !== 'newest'): ?>
          <a href="college_enrollment_queue.php" class="btn btn-sm btn-outline-secondary rounded-pill px-2.5 py-0.5 extra-small d-inline-flex align-items-center gap-1">
            <i class="bi bi-x-circle"></i> Reset Filters
          </a>
        <?php endif; ?>
      </div>
      <div class="p-3">
        <form action="college_enrollment_queue.php" method="GET" class="row g-2.5 align-items-center">
    ...
    <div class="dossier-card fade-in-up" style="animation-delay: 0.15s;">
      <div class="dossier-card-header">
        <div class="d-flex align-items-center gap-2.5">
          ...
          <div>
            <h2 class="h5 fw-bold text-dark mb-0 d-inline-block align-middle">College Enrollees Queue</h2>
          </div>
        </div>
      </div>
                ...
                <tr>
                  <td colspan="7" class="text-center py-5">
                    <div class="d-flex flex-column align-items-center justify-content-center py-4 text-muted">
                      ...
                      <p class="small text-muted mb-0">No college applications are currently awaiting enrollment finalization.</p>
                    </div>
                  </td>
                </tr>
              <?php else: ?>
                <?php foreach ($applications as $app): ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 rounded-pill px-2.5 py-0.5 small fw-semibold mb-1">
