        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-body p-4">
                    <form action="/sia/lms/faculty/course/<?= esc($course['lms_course_id']) ?>/announcements/<?= esc($announcement ? $announcement['id'] . '/update' : 'store') ?>" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" class="form-select">
                                <option value="draft" <?= esc(($announcement['status'] ?? '') === 'draft' ? 'selected' : '') ?>>Draft</option>
                                <option value="published" <?= esc(($announcement['status'] ?? '') === 'published' ? 'selected' : '') ?>>Published</option>
                            </select>
                        </div>
