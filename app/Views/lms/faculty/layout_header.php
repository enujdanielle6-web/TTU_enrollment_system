...
<aside class="lms-sidebar" id="lmsSidebar">
    ...
    <div class="lms-sidebar-footer">
        ...
        <a href="/sia/auth/lms_faculty_logout.php" class="btn btn-light w-100 text-danger fw-semibold d-flex align-items-center justify-content-center gap-2 border lms-logout-btn">
