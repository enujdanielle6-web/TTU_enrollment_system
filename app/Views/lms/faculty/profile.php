...
<div class="container-fluid py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/sia/lms/faculty/dashboard.php" class="text-decoration-none">Dashboard</a></li>
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            ...
            <div class="lms-card p-4 text-center border-0 shadow-sm mb-4 position-relative overflow-hidden">
                ...
                <h4 class="fw-bold mb-1"><?= htmlspecialchars($_SESSION['user_name'] ?? $_SESSION['lms_name'] ?? 'Faculty Name') ?></h4>
                <p class="text-muted mb-3"><?= htmlspecialchars($_SESSION['user_email'] ?? $_SESSION['lms_email'] ?? 'faculty@ttu.edu.ph') ?></p>
                ...
                <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <span class="fw-medium text-dark">Faculty / Instructor</span>
                        </div>
                    </li>
                    <li class="d-flex align-items-center mb-3">
            ...
            <div class="lms-card p-4 border-0 shadow-sm h-100">
                ...
                <div class="mb-4">
                    ...
                    <div class="form-check form-switch mb-3">
                        ...
                        <small class="d-block text-muted">Receive email updates for student submissions.</small>
                    </div>
                    <div class="form-check form-switch">
                        ...
                        <small class="d-block text-muted">Show bell alerts for course activity.</small>
                    </div>
                </div>

                <div class="mb-4">
                    <h6 class="fw-bold text-dark mb-3">Office Hours</h6>
                    <p class="text-muted small">Update your default office hours display for students.</p>
                    <textarea class="form-control" rows="3" placeholder="E.g., Monday-Wednesday 2:00 PM - 4:00 PM"></textarea>
                </div>
