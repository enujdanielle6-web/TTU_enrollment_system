...
require_once __DIR__ . '/../components/applicant_navbar.php';
?>
...
<main id="spa-main" class="py-5 bg-light min-vh-100">
  <div class="container px-lg-5">
    ...
    <?php 
      $hasCompletedDeclaration = $health && !empty($health['height']) && !empty($health['weight']) && !empty($health['blood_type']);
      if ($hasCompletedDeclaration && in_array($health['status'], ['pending', 'under_review', 'verified', 'rejected'])): 
    ?>
