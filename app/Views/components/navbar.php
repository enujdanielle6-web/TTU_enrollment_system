...
<nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top main-navbar">
  <div class="container">
    <a class="navbar-brand d-flex align-items-center gap-2" href="#hero" aria-label="Triple T University home">
      <img src="/sia/images/TTU_LOGO.png" alt="TTU Logo" style="height: 40px; width: auto; object-fit: contain;">
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
        ...
        <?php if (!empty($_SESSION['logged_in'])): ?>
          <li class="nav-item ms-lg-2">
            <?php if (in_array($_SESSION['user_role'] ?? '', ['superadmin', 'admissions', 'scholarship', 'cashier'], true)): ?>
              <a class="nav-link nav-login" href="/sia/admin/dashboard.php">
                <i class="bi bi-grid"></i>
                Dashboard
              </a>
            <?php else: ?>
              <a class="nav-link nav-login" href="/sia/applicant/dashboard.php">
                <i class="bi bi-grid"></i>
                Dashboard
              </a>
            <?php endif; ?>
          ...
          <li class="nav-item">
            <a class="btn btn-outline-primary nav-register" href="/sia/auth/logout.php">
        ...
        <?php else: ?>
          <li class="nav-item ms-lg-2">
            <a class="nav-link nav-login" href="/sia/auth/login.php">
              <i class="bi bi-box-arrow-in-right"></i>
              Login
            </a>
          </li>
          <li class="nav-item">
            <a class="btn btn-primary nav-register" href="/sia/auth/register.php">
