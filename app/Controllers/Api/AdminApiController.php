...
{
    public function getCurriculaByProgram(Request $request, Response $response)
    {
...
try {
    ...
    public function getCurriculumSubjectsPreview(Request $request, Response $response)
    {
        $pdo = Database::getConnection();
...
try {
    ...
    public function getEnrollmentSummary(Request $request, Response $response)
    {
        $pdo = Database::getConnection();
