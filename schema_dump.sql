...
--
-- Table structure for table `application_subject_requests`
--
...
CREATE TABLE `college_programs` (
  ...
  `custom_tuition` varchar(100) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE `college_section_subjects` (
  ...
  `delivery_mode` varchar(50) NOT NULL DEFAULT 'Face-to-Face',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `college_section_id` (`college_section_id`),
  KEY `subject_id` (`subject_id`),
  KEY `idx_css_faculty_user_id` (`faculty_user_id`),
...
CREATE TABLE `faculty_availability` (
  ...
  CONSTRAINT `fk_fa_faculty_user` FOREIGN KEY (`faculty_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `faculty_profiles` (
  ...
  CONSTRAINT `fk_faculty_profiles_program` FOREIGN KEY (`program_id`) REFERENCES `college_programs` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_faculty_profiles_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `faculty_specializations`
--
...
CREATE TABLE `receipt_sequences` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sequence_year` int(10) unsigned NOT NULL,
...
CREATE TABLE `shs_section_subjects` (
  ...
  KEY `shs_section_id` (`shs_section_id`),
  KEY `subject_id` (`subject_id`),
  KEY `idx_sss_faculty_user_id` (`faculty_user_id`),
...
CREATE TABLE `users` (
  ...
  `lms_status` enum('inactive','active','suspended') NOT NULL DEFAULT 'inactive',
