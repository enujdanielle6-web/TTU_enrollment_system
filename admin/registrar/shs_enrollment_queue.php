...
<main class="py-5 bg-light min-vh-100">
  <div class="container-fluid px-lg-5">
    ...
    <div class="island island-hero mb-4 d-flex justify-content-between align-items-center">
      <div>
        <h1 class="h3 fw-bold text-dark mb-1">SHS Enrollment Queue</h1>
    ...
    <div class="island position-relative overflow-hidden border-0 shadow-sm mb-4" style="border-radius: 16px;">
      ...
      <div class="island-body py-3">
        <form action="shs_enrollment_queue.php" method="GET" class="row g-3 align-items-center">
          ...
          <div class="col-md-auto">
            ...
            <?php if ($search !== '' || $sortOrder !== 'newest'): ?>
              <a href="shs_enrollment_queue.php" class="btn btn-sm btn-outline-secondary rounded-pill">Clear</a>
            <?php endif; ?>
          </div>
        </form>
      </div>
