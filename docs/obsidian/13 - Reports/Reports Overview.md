...
| **Scholarship Impact** | Total tuition discounts awarded, active scholars count, and budget allocation per scholarship program. | `scholarships`, `scholarship_recipients`, `applications` |
